...
Class AdminController extends Controller
{
    ...
    {
        return $this->view->render($response, 'admin/auth/organizaciones.twig');
    }
    ...
    {
        return $this->view->render($response, 'admin/auth/materiales.twig');
    }
    ...
    public function validar($login, $clave)
    {
        ...
        if (password_verify($clave, $admin->clave)) {
            ...
            $_SESSION['distrito'] = $admin->distrito;
            return true;
        }
        return false;
    }
